<?php
require_once $_SERVER["DOCUMENT_ROOT"].ROOT_URL."/admin/objetos/tipo_imovel.php";

class ModelTipo {

    public static $instance;
    public static $table = "tipo_imovel";

    public static function  getInstance() {
        if (!isset(self::$instance))
            self::$instance = new ModelTipo();

        return self::$instance;
    }

    public static function inserir(TipoImovel $objeto) {
        try {
    ...
    public static function update(TipoImovel $classe) {
        try {
